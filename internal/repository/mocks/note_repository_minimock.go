...
//go:generate minimock -i github.com/grishagavrin/auth-chat-grpc/internal/repository.NoteRepository -o note_repository_minimock.go -n NoteRepositoryMock -p mocks
